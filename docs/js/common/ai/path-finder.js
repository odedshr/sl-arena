...
function isValidPosition(position, dimensions, obstacles, isLoop) {
...
function getNextPosition(pos, towards, dimensions, isLoop) {
...
export { getPathToNearestTarget, isValidPosition, getNextPosition };
